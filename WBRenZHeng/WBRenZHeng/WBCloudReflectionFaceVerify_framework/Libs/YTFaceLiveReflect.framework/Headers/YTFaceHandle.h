...
#define YT_FACE_REFLECT_VERSION @"3.6.8"
 ...
 */
typedef void (^onFinish)(int ret, YTFullPack fullPack, void* bestImgMat);
 ...
 */
- (void)PushImgSequence:(void*)faceRgbMat faceAlign:(NSMutableArray* _Nonnull)faceAlign timeStamp:(uint64_t)timeStamp;
