...
typedef struct yt_face_tracker_param_t {
...
} yt_face_tracker_param;

typedef struct yt_tracked_face_t {
 ...
 */
YT_PUBLIC const char *yt_face_tracker_get_version();
 ...
 */
YT_PUBLIC int yt_face_tracker_create_handle(yt_handle *handle, const char *model_dirpath, const char *config_filename);
 ...
 * @return YT_SUCCESS：成功，其他：失败
 */
YT_PUBLIC int yt_face_tracker_create_handle_android(yt_handle *handle, AAssetManager *mgr, const char *model_dirpath, const char *config_filename);
#endif
 ...
 */
YT_PUBLIC void yt_face_tracker_destroy_handle(yt_handle handle);
 ...
 * @return YT_SUCCESS：成功，其他：失败
 */
YT_PUBLIC int yt_face_tracker_get_param(yt_handle handle, yt_face_tracker_param *param);
 ...
 * @return YT_SUCCESS：成功，其他：失败
 */
YT_PUBLIC int yt_face_tracker_set_param(yt_handle handle, const yt_face_tracker_param param);
 ...
 * @return YT_SUCCESS：成功，其他：失败
 */
YT_PUBLIC int yt_face_tracker_reset(yt_handle handle);
 ...
 */
YT_PUBLIC void yt_face_tracker_release_tracked_faces(yt_tracked_face *tracked_faces);
